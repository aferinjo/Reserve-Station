...
holopad-window-call-in-progress = Идет голо-вызов
...
holopad-window-request-station-ai = Запросить станцию AI
...
# Список контактов
holopad-window-select-contact-from-list = Выбрать контакт для инициирования головызова
