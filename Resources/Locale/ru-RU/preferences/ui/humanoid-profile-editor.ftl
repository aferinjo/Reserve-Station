...
humanoid-profile-editor-uplink-pda = КПК
...
humanoid-profile-editor-guidebook-button = Руководство
...
humanoid-profile-editor-antag-preference-yes-button = Включено
humanoid-profile-editor-antag-preference-no-button = Выключено
