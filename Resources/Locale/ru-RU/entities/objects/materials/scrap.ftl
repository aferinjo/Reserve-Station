...
ent-BaseScrapLarge = Лом
    .desc = Бесполезный хлам. Хотя, возможно, из него можно получить какие-нибудь материалы.
    .suffix = Лом
...
ent-ScrapGeneratorPlasmaLeaking = протекающий генератор П.А.К.М.А.Н.
    .desc = Генератор П.А.К.М.А.Н., выглядящий довольно старым. Из него вытекает плазма.
    .suffix = { ent-BaseScrapLarge.suffix }
ent-ScrapGeneratorPlasma = старый генератор П.А.К.М.А.Н.
    .desc = Генератор П.А.К.М.А.Н., выглядящий довольно старым. Он находится в очень плохом состоянии и неисправен.
    .suffix = { ent-BaseScrapLarge.suffix }
ent-ScrapGeneratorUraniumLeaking = протекающий генератор С.У.П.Е.Р.П.А.К.М.А.Н.
    .desc = Генератор С.У.П.Е.Р.П.А.К.М.А.Н., который, по всей видимости, вышел из строя из-за какой-то катастрофы. Из него вытекает уран.
    .suffix = { ent-BaseScrapLarge.suffix }
ent-ScrapGeneratorUranium = разрушенный генератор С.У.П.Е.Р.П.А.К.М.А.Н.
    .desc = Генератор С.У.П.Е.Р.П.А.К.М.А.Н., который, по всей видимости, вышел из строя из-за какой-то катастрофы.
    .suffix = { ent-BaseScrapLarge.suffix }
ent-ScrapGeneratorFrame = каркас генератора
    .desc = Каркас генератора типа П.А.К.М.А.Н. или С.У.П.Е.Р.П.А.К.М.А.Н. Где остальная его часть?
    .suffix = { ent-BaseScrapLarge.suffix }
ent-ScrapGeneratorFuelTank = топливный бак генератора
    .desc = Топливный бак генератора типа С.У.П.Е.Р.П.А.К.М.А.Н. Указатель уровня топлива показывает, что немного в нём ещё осталось.
    .suffix = { ent-BaseScrapLarge.suffix }
