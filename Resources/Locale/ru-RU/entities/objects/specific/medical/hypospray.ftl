...
ent-AntiPoisonMedipen = автоинъектор противоядия
    .desc = Экспресс-доза противоядия. Содержит ультраваскулин и эпинефрин. Вызывает сильный стресс при смешивании с другими лекарствами.
...
ent-SpaceMedipen = космический медипен
    .desc = Содержит смесь химических веществ, которые временно защитят вас от опасного низкого давления и стабилизируют температуру вашего тела.
...
ent-WehMedipen = автоинъектор веха
    .desc = Экспресс-доза веханья. Содержит сок, который заставляет вас вехать.
