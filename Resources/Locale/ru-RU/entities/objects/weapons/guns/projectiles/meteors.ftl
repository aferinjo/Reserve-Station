...
ent-MeteorUrist = Урист МакМетеор
    ...
    .suffix = Метеор
ent-MeteorCow = корова-метеор
    .desc = Двигается сквозь млечный путь со скоростью, сопоставимой со скоростью света!
    .suffix = Метеор
ent-MeteorClown = хонкостероид
    .desc = Последнее клоунение!
    .suffix = Метеор
ent-MeteorPotato = космо-картофель
    .desc = Крахмальная угроза из глубин космоса. Содержит 200% вашей суточной нормы натрия!
    .suffix = Метеор
