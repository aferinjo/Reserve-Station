...
ent-WeaponDisablerPractice = тренировочный станнер
    ...
    .suffix = Пистолет
ent-WeaponTaser = шокер
    .desc = Электрошокер малой мощности, используемый службой безопасности для подавления целей на расстоянии.
    .suffix = Пистолет
ent-WeaponTaserSuper = элитный шокер
    .desc = Электрошокер малой мощности, используемый элитными командами безопасности для подавления даже самых трудных целей.
    .suffix = Адмем, Пистолет
