...
ent-WeaponShotgunHushpup = Волкодав
    .desc = Редкая модификация Силовика, оснащенная громоздким глушителем. Отлично подойдет тем, кто придерживается строгих моральных принципов. Вмещает 5 патронов 12-го калибра.
    .suffix = Дробовик
