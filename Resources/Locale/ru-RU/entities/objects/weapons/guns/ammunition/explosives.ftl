...
ent-CartridgeRocketSingularityBuster = антисингулярный ракетный выстрел
    .desc = Боеголовка, содержащая большое количество античастиц. При столкновении с сингулярностью античастицы высвобождаются, разрушая сингулярность. Гарантия аннулируется, если ракета столкнется с чем-либо, кроме сингулярности или теслы.
...
ent-GrenadeFrag = осколочная граната
    .desc = { ent-BaseGrenade.desc }
ent-GrenadeCleanade = заряд чистящей гранаты
    .desc = { ent-BaseGrenade.desc }
