...
ent-DeathRattleLavalandImplant = имплант "предсмертный хрип" Лаваленда
    .desc = Этот имплант сообщит по радиоканалу снабжения, если пользователь окажется в критическом состоянии или умрёт. Работает только на поверхности лаваленда и сообщает точные координаты смерти.
