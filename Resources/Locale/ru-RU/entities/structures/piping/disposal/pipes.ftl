...
ent-DisposalSignaller = сигнальщик утилизационной трубы
    .desc = Труба, издающая сигнал, когда через неё проходит предмет.
...
ent-DisposalXJunction = X-развязка утилизационной трубы
    .desc = Четырёхсторонняя развязка. Стрелка указывает на выход.
