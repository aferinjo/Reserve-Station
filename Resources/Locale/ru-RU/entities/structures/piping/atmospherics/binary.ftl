...
ent-GasPressureRegulator = регулятор входного давления
    .desc = Клапан, выпускающий газ, когда входное давление превышает определённый пороговый уровень.
...
ent-HeatExchangerBend = { ent-HeatExchanger }
    ...
    .suffix = Изгиб
ent-HeatExchangerInline = внедрённый { ent-HeatExchanger }
    .desc = { ent-HeatExchanger.desc } Не нуждается в газовом потоке.
ent-HeatExchangerInlineBend = { ent-HeatExchangerInline }
