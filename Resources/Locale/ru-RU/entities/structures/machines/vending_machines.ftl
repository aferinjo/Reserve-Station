...
ent-VendingMachineShamblersJuice = торгомат Сок Шемблер
    .desc = ~Встряхните мне немного этого сока Шемблер!~
ent-VendingMachinePwrGame = торгомат Пауэр Гейм
    .desc = Вы этого хотите, у нас это есть. В партнёрстве с компанией Салаты Влада.
...
ent-VendingMachineCola = Прохладительные напитки Robust
    .desc = Автомат прохладительных напитков, предоставленный компанией Робаст Индастриз
ent-VendingMachineDinnerware = ПосудоМат
    .desc = Поставщик оборудования для кухонь и ресторанов.
ent-VendingMachineDiscount = Дискаунтер Дена
    .desc = Торговый автомат с закусками из печально известной франшизы "Дискаунтер Дена".
...
ent-VendingMachineSnackBlue = Гетмор Шоколад' Корп.
    .suffix = Синий
...
ent-VendingMachinePride = РадугоМат
    .desc = Торговый автомат, полный цветастой одежды и побрякушек.
...
ent-VendingMachineChemicalsSyndicate = СиндиСоки
    ...
    .suffix = { ent-VendingMachineChemicals }, Синдикат
