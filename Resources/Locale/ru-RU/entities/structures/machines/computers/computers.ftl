...
ent-ComputerSalvageJobBoard = консоль утилизаторских работ
    .desc = Консоль с доской утилизаторских заказов, если думаешь что осилишь.
...
ent-BaseHandheldStationMapSupermatterCe = ручная консоль мониторинга суперматерии
    .desc = Высококачественная портативная консоль для мониторинга состояния суперматерии, предназначенная для старших инженеров. Позволяет пользователю отслеживать состояние суперматерии.
