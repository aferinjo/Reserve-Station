...
ent-AlwaysPoweredFloorLight = напольный светильник
    .desc = Всегда работающий напольный светильник.
    .suffix = Всегда запитанный
ent-PoweredFloorLightEmpty = { ent-AlwaysPoweredFloorLight }
    .desc = Осветительный прибор, встроенный в пол. Потребляет электроэнергию и светит при использовании лампочки.
    .suffix = Пустой
ent-PoweredFloorLight = { ent-PoweredFloorLightEmpty }
    .desc = { ent-PoweredFloorLightEmpty.desc }
