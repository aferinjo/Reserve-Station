ent-RandomHumanoidVisitorCaptain = посетитель Капитан роль призрака
    .desc = { "" }
ent-RandomHumanoidVisitorCE = посетитель старший инженер роль призрака
    .desc = { "" }
ent-RandomHumanoidVisitorCMO = посетитель главный врач роль призрака
    .desc = { "" }
ent-RandomHumanoidVisitorHOP = посетитель глава персонала роль призрака
    .desc = { "" }
ent-RandomHumanoidVisitorHOS = посетитель глава службы безопасности роль призрака
    .desc = { "" }
ent-RandomHumanoidVisitorRD = посетитель научный руководитель роль призрака
    .desc = { "" }
ent-RandomHumanoidVisitorQM = посетитель квартирмейстер роль призрака
    .desc = { "" }
...
ent-RandomHumanoidVisitorLawyer = посетитель адвокат роль призрака
    .desc = { "" }
ent-RandomHumanoidVisitorLawyerCentcom = посетитель адвокат ЦентКом роль призрака
    .desc = { "" }
