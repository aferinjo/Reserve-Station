...
ent-ClothingHandsTacticalMaidGloves = тактические перчатки уборщика
    .desc = Тактические перчатки для уборщиков - каждый уважающий себя боевой уборщик обязан иметь такие.
