...
knowledge-path-side-s3-shark-desc =
    ...
    Позволяет превратить кучку пепла, печень и кусок плазмы в огненную акулу.
    Огненные акулы быстры и сильны в группах, но быстро погибают. Они также обладают высокой устойчивостью к атакам огнём.
    Огненные акулы поджигают своих жертв и после их смерти извергают плазму.
...
knowledge-path-side-s6-ice-spear-desc = Артефакты, связанные с Зимним рассветом, излучают неестественную неподвижность. Время вокруг них замирает. Огни гаснут. Мысли становятся хрупкими. Близость порождает галлюцинации бескрайних белых полей, неба без солнца и голоса, что говорят лишь звуком трескающегося льда.
