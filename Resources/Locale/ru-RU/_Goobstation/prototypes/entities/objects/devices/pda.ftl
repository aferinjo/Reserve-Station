...
ent-NavyCaptainPDA = КПК капитана ВКС
    .desc = Дьявол кроется в деталях.
ent-NavyOfficerPDA = КПК офицера ЦентКом
...
ent-VirologistPDA = КПК вирусолога
    .desc = Вы не уверены, безопасно ли прикасаться к нему.
ent-SecurityClownPDA = КПК клоуна СБ
    .desc = У кого из службы безопасности есть розовый КПК?
ent-CommandMaidPDA = КПК уборщика командования
    .desc = { ent-JanitorPDA.desc }
ent-PartyMakerPDA = КПК организатора вечеринок
...
ent-RadioHostPDA = КПК радиоведущего
    .desc = Вы слушаете плавные звуки на частоте 145,9 FM.
ent-OuterCommandPDA = КПК внешнего командования
    .desc = Фиолетовый КПК для членов внешнего командования.
