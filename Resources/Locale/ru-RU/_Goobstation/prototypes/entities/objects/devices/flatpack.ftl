...
ent-ComputerNTRTasksFlatpack = упакованная консоль заданий представителя NanoTrasen
...
ent-SlotMachineFlatpack = упакованный игровой автомат
    .desc = Упаковка, при помощи которой можно создать игровой автомат.
ent-SlotMachineHighRollerFlatPack = упакованный особый игровой автомат
    .desc = Упаковка, при помощи которой можно создать особый игровой автомат.
ent-CoinFlipperFlatPack = упакованный подбрасыватель монет
    .desc = Упаковка, при помощи которой можно создать подбрасыватель монет.
ent-ClawMachineFlatPack = упакованный автомат с игрушками
    .desc = Упаковка, при помощи которой можно создать автомат с игрушками.
ent-ChemistryHotplateFlatPack = упакованная электроплитка
    .desc = Упаковка, при помощи которой можно создать электроплитку.
ent-DiseaseDiagnoserFlatPack = упакованный диагностировщик болезней
    .desc = Упаковка, при помощи которой можно создать диагностировщик болезней.
