...
uplink-grey-tide-name = Серая волна
uplink-grey-tide-desc = Древний артефакт с магическими свойствами. Идентичен плазменному копью, но способен вызывать иллюзии при попадании в живого моба, если владелец копья - ассистент.
...
uplink-heavy-shotgun-magazine-name = Барабан для тяжелого дробовика (2 калибр)
uplink-heavy-shotgun-magazine-desc = Магазин для дробовика с 15 фугасными снарядами. Совместим с NZ CSG-242.

uplink-heavy-shotgun-magazine-slug-name = Барабан для тяжелого дробовика (2 калибр ОФ)
...
uplink-autosurgeon-right-mantis-blade-name = Автохирург (правое лезвие боголома)
uplink-autosurgeon-left-mantis-blade-name = Автохирург (левое лезвие богомола)
...
uplink-autosurgeon-recoil-absorbing-name = Автохирург (поглощение отдачи)
uplink-autosurgeon-recoil-absorbing-desc = Модифицирует ваши руки, добавляя поглощение отдачи, значительно снижая отдачу при стрельбе из дальнобойного оружия. Требует слишком тонкой настройки для человека, комплектуется одноразовым автохирургом для установки.

uplink-autosurgeon-berserker-heart-name = Автохирург (берсерк)
uplink-autosurgeon-berserker-heart-desc = Заменяет ваше сердце имплантом берсерка, который позволяет входить в состояние ярости, значительно увеличивая урон в ближнем бою, скорость и предотвращая падение в критическое состояние. Требует слишком тонкой настройки для человека, комплектуется одноразовым автохирургом для установки.

uplink-autosurgeon-jumpstarter-heart-name = Автохирург (стартер)
uplink-autosurgeon-jumpstarter-heart-desc = Заменяет ваше сердце имплантом инъектора-стартера, который вводит достаточно омнизина, чтобы подняться после падения в критическое состояние. Имеет перезагрядку в 3 минуты. Требует слишком тонкой настройки для человека, комплектуется одноразовым автохирургом для установки.
...
uplink-guerrilla-gloves-name = Партизанские перчатки
uplink-guerrilla-gloves-desc = Специальная пара ударопрочных перчаток, которые по умолчанию обеспечивают жёсткий захват, снижают ваше замедление при активном захвате и затрудняют жертвам возможность ускользнуть от ваших захватов.
...
uplink-customboard-name = Настраиваемая плата законов Синдиката
uplink-customboard-desc = Модифицированная плата законов ИИ, которая позволяет пользователю изменять законы по своему усмотрению. Поставляется с предустановленными законами Антимова.

uplink-cddisksyndicate-name = CD-диск рекламы Синдиката
uplink-cddisksyndicate-desc = 102.9 Syndicate radio.

uplink-cddisknumber-name = CD-диск номерной станции
uplink-cddisknumber-desc = Вызовите угрозу, чтобы отвлечь внимание станции... удачи во всем этом.

uplink-box-xenobio-name = Коробка слаймов ксенобиологии
uplink-box-xenobio-desc = Слаймы для нужд ксенобиологии. Содержит 9 слаймов первого уровня

# Contractor

uplink-moduist-contractor-name = MOD контрактника
uplink-moduist-contractor-desc = Этот лёгкий MOD был создан специально для Гильдии! Изготовлен из пластитана, что обеспечивает исключительную прочность, но в то же время лёгкий вес, оснащён сервоприводами, которые помогут вам сильнее захватывать, инжекторами, обнаруживающими критические повреждения, и встроенной технологией хамелеона! Чтобы сохранить свой сверхлёгкий вес, этот MOD не имеет возможностей для хранения.

uplink-hardsuit-contractor-name = Пустотный костюм контрактника
uplink-hardsuit-contractor-desc = Этот лёгкий пустотный костюм был создан специально для Гильдии! Его можно легко сложить в рюкзак.

uplink-webbing-contractor-name = РПС контрактника
uplink-webbing-contractor-desc = Нагрудный РПС с глубокими карманами и взрывозащищенностью, часто используемое контрактниками и охотниками за головами.

uplink-jetpack-contractor-name = Джетпак контрактника
uplink-jetpack-contractor-desc = Этот джетпак был создан специально для Гильдии! Обладает высокой маневренностью и приличным запасом топлива, что идеально подходит для быстрого бегства. Имеет встроенные ремни для хранения костюма.
...
uplink-ExplosivePayloadBlueprint-desc = Чертёж, который позволит одному лату печатать взрывные заряды, незаконное устройство, используемое для создания гранат.
