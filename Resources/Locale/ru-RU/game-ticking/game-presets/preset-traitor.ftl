...
traitor-role-greeting-telecrystals =
    Вы - агент организации { $corporation } на задании [color = darkred]Синдиката.[/color].
    Ваши цели и кодовые слова перечислены в меню персонажа.
    Вместо аплинка вам выдали горсть чистых телекристаллов. Сами по себе они бесполезны, но вы можете найти другого агента Синдиката, готового обменять их на что-то полезное.
    Смерть Nanotrasen!
